...
(function () {
  ...
  var CONFIG = {
    hotelName: 'Hotel Augustiner Tor',

    primaryColor: '#15395b',  // Akzentfarbe (CTA)
    textColor: '#17212d',

    headline: 'Direkt buchen – Bestpreisgarantie',
    benefitText: 'Fragen Sie Ihren Aufenthalt direkt beim Hotel Augustiner Tor an.',
    ...
    privacyUrl: 'https://www.hotel-augustiner-tor.de/datenschutz/',
  ...
  var KEY = 'augustiner_dbw_seen', ui = null, isOpen = false, fired = false, lastFocus = null, prevOv = '';
