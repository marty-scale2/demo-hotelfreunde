...
(function () {
  ...
  var CONFIG = {
    hotelName: 'Hotel Hirschen Konstanz',

    primaryColor: '#006664',  // Hirschen-Türkis
    textColor: '#1a1c22',

    headline: 'Am besten direkt ins Hirschen',
    benefitText: 'Aktuelle Verfügbarkeit direkt beim Hotel ansehen.',
  ...
  var KEY = 'hirschen_dbw_seen', ui = null, isOpen = false, fired = false, lastFocus = null, prevOv = '';
